...
int main(int argc, char *argv[]) {
  ...
  // 1000000, (float) (time1-time0) / (float) (time7-time0) * 100); printf("%15.12f s, %15.12f % : INPUT ARGUMENTS\n",
  // (float) (time2-time1) / 1000000, (float) (time2-time1) / (float) (time7-time0) * 100); printf("%15.12f s, %15.12f %
  // : INPUTS\n",							(float) (time3-time2) / 1000000, (float)
  // (time3-time2) / (float) (time7-time0) * 100); printf("%15.12f s, %15.12f % : dim_cpu\n",
  // (float) (time4-time3) / 1000000, (float) (time4-time3) / (float) (time7-time0) * 100); printf("%15.12f s, %15.12f %
  // : SYS MEM: ALO\n",						(float) (time5-time4) / 1000000, (float) (time5-time4) /
  // (float) (time7-time0) * 100);

  // printf("%15.12f s, %15.12f % : KERNEL: COMPUTE\n",					(float) (time6-time5) / 1000000,
  // (float) (time6-time5) / (float) (time7-time0) * 100);

  // printf("%15.12f s, %15.12f % : SYS MEM: FRE\n", 					(float) (time7-time6) / 1000000,
  // (float) (time7-time6) / (float) (time7-time0) * 100);
