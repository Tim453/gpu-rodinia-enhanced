...
template <bool isNP2>
__device__ static void loadSharedChunkFromMem(unsigned int *s_data, const unsigned int *g_idata, int n, int baseIndex,
...
template <bool isNP2>
__device__ static void storeSharedChunkToMem(unsigned int *g_odata, const unsigned int *s_data, int n, int ai, int bi,
...
__device__ static void clearLastElement(unsigned int *s_data, unsigned int *g_blockSums, int blockIndex) {
  if (threadIdx.x == 0) {
...
__global__ static void prescan(unsigned int *g_odata, const unsigned int *g_idata, unsigned int *g_blockSums, int n,
...
__global__ static void uniformAdd(unsigned int *g_data, unsigned int *uniforms, int n, int blockOffset, int baseIndex) {
