...
void master(fp timeinst, fp *initvalu, fp *parameter, fp *finavalu, fp *com,
  ...
  blocks.x = 2;
  blocks.y = 1;
  kernel<<<blocks, threads>>>(timeinst, d_initvalu, d_finavalu, d_params, d_com);
  ...
  kernel_fin(initvalu, initvalu_offset_ecc, initvalu_offset_Dyad, initvalu_offset_SL, initvalu_offset_Cyt, parameter,
             finavalu, com[0], com[1], com[2]);
