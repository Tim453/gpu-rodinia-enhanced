...
//	MAIN FUNCTION
//=====================================================================
__device__ void kernel_fin_2(int timeinst, fp *d_initvalu, fp *d_finavalu, int offset_ecc, int offset_Dyad,
                             int offset_SL, int offset_Cyt, fp *d_params, fp *d_com) {
  ...
  CaMtotDyad = d_initvalu[offset_Dyad + 0] + d_initvalu[offset_Dyad + 1] + d_initvalu[offset_Dyad + 2] +
               d_initvalu[offset_Dyad + 3] + d_initvalu[offset_Dyad + 4] + d_initvalu[offset_Dyad + 5] +
               CaMKIItotDyad * (d_initvalu[offset_Dyad + 6] + d_initvalu[offset_Dyad + 7] +
                                d_initvalu[offset_Dyad + 8] + d_initvalu[offset_Dyad + 9]) +
               d_initvalu[offset_Dyad + 12] + d_initvalu[offset_Dyad + 13] + d_initvalu[offset_Dyad + 14];
  Bdyad = BtotDyad - CaMtotDyad; // [uM dyad]
  J_cam_dyadSL =
      1e-3 * (k0Boff * d_initvalu[offset_Dyad + 0] - k0Bon * Bdyad * d_initvalu[offset_SL + 0]); // [uM/msec dyad]
  J_ca2cam_dyadSL =
      1e-3 * (k2Boff * d_initvalu[offset_Dyad + 1] - k2Bon * Bdyad * d_initvalu[offset_SL + 1]); // [uM/msec dyad]
  J_ca4cam_dyadSL =
      1e-3 * (k2Boff * d_initvalu[offset_Dyad + 2] - k4Bon * Bdyad * d_initvalu[offset_SL + 2]); // [uM/msec dyad]
