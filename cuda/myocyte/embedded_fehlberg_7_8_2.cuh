...
// This file is the modified version of embedded fehlberg 7.8 solver obrained from
// (http://mymathlib.webtrellis.net/index.html) Lukasz G. Szafaryn 15 DEC 09
...
//                        + 9/35 * finavalu_temp[7] + 9/280 * finavalu_temp[8] + 9/280 finavalu_temp[9] + 41/840
//                        finavalu_temp[10] ) //
//     where                                                                  //
//     k1 = f( x[i],y[i] ),                                                   //
...
//     finavalu_temp[5] = f( x[i]+h/2, y[i]+h/20*( k1 + 5 finavalu_temp[3] + 4 finavalu_temp[4] ) ), // finavalu_temp[6]
//     = f( x[i]+5h/6, y[i]+h/108*( -25 k1 + 125 finavalu_temp[3] - 260 finavalu_temp[4] + 250 finavalu_temp[5] ) ), //
//     finavalu_temp[7] = f( x[i]+h/6, y[i]+h*( 31/300 k1 + 61/225 finavalu_temp[4] - 2/9 finavalu_temp[5] //
//                                                            + 13/900 finavalu_temp[6]) )  //
//     finavalu_temp[8] = f( x[i]+2h/3, y[i]+h*( 2 k1 - 53/6 finavalu_temp[3] + 704/45 finavalu_temp[4] - 107/9
//     finavalu_temp[5]      //
...
//                             + 311/54 finavalu_temp[5] - 19/60 finavalu_temp[6] + 17/6 finavalu_temp[7] - 1/12
//                             finavalu_temp[8]) ), //
//     finavalu_temp[10] = f( x[i]+h, y[i]+h*( 2383/4100 k1 - 341/164 finavalu_temp[3] + 4496/1025 finavalu_temp[4] //
//          - 301/82 finavalu_temp[5] + 2133/4100 finavalu_temp[6] + 45/82 finavalu_temp[7] + 45/164 finavalu_temp[8] +
//          18/41 finavalu_temp[9]) )  //
//     finavalu_temp[11] = f( x[i], y[i]+h*( 3/205 k1 - 6/41 finavalu_temp[5] - 3/205 finavalu_temp[6] - 3/41
//     finavalu_temp[7]        //
...
//                      - 289/82 finavalu_temp[5] + 2193/4100 finavalu_temp[6] + 51/82 finavalu_temp[7] + 33/164
//                      finavalu_temp[8] +   //
...
__device__ void embedded_fehlberg_7_8_2(fp h,
                                        ...
                                        fp timeinst, fp *initvalu, fp *finavalu, fp *parameter,

                                        fp *error, fp *initvalu_temp, fp *finavalu_temp, fp *com) {
  ...
  for (j = 0; j < 13; j++) {
    ...
    //===================================================================================================
      ...
      for (i = 0; i < EQUATIONS; i++) {
        initvalu_temp[i] =
            initvalu[i] + h * (b31 * finavalu_temp[0 * EQUATIONS + i] + b32 * finavalu_temp[1 * EQUATIONS + i]);
      }
    ...
    //===================================================================================================
      ...
      for (i = 0; i < EQUATIONS; i++) {
        initvalu_temp[i] =
            initvalu[i] + h * (b41 * finavalu_temp[0 * EQUATIONS + i] + b43 * finavalu_temp[2 * EQUATIONS + i]);
      }
    ...
    //===================================================================================================
      ...
      for (i = 0; i < EQUATIONS; i++) {
        initvalu_temp[i] =
            initvalu[i] + h * (b51 * finavalu_temp[0 * EQUATIONS + i] + b53 * finavalu_temp[2 * EQUATIONS + i] +
    ...
    //===================================================================================================
      ...
      for (i = 0; i < EQUATIONS; i++) {
        initvalu_temp[i] =
            initvalu[i] + h * (b61 * finavalu_temp[0 * EQUATIONS + i] + b64 * finavalu_temp[3 * EQUATIONS + i] +
    ...
    //===================================================================================================
      ...
      for (i = 0; i < EQUATIONS; i++) {
        initvalu_temp[i] =
            initvalu[i] + h * (b71 * finavalu_temp[0 * EQUATIONS + i] + b74 * finavalu_temp[3 * EQUATIONS + i] +
                               b75 * finavalu_temp[4 * EQUATIONS + i] + b76 * finavalu_temp[5 * EQUATIONS + i]);
      }
    ...
    //===================================================================================================
      ...
      for (i = 0; i < EQUATIONS; i++) {
        initvalu_temp[i] =
            initvalu[i] + h * (b81 * finavalu_temp[0 * EQUATIONS + i] + b85 * finavalu_temp[4 * EQUATIONS + i] +
                               b86 * finavalu_temp[5 * EQUATIONS + i] + b87 * finavalu_temp[6 * EQUATIONS + i]);
      }
    ...
    //===================================================================================================
      ...
      for (i = 0; i < EQUATIONS; i++) {
        initvalu_temp[i] =
            initvalu[i] + h * (b91 * finavalu_temp[0 * EQUATIONS + i] + b94 * finavalu_temp[3 * EQUATIONS + i] +
                               b95 * finavalu_temp[4 * EQUATIONS + i] + b96 * finavalu_temp[5 * EQUATIONS + i] +
                               b97 * finavalu_temp[6 * EQUATIONS + i] + b98 * finavalu_temp[7 * EQUATIONS + i]);
      }
    ...
    //===================================================================================================
      ...
      for (i = 0; i < EQUATIONS; i++) {
        initvalu_temp[i] =
            initvalu[i] + h * (b10_1 * finavalu_temp[0 * EQUATIONS + i] + b10_4 * finavalu_temp[3 * EQUATIONS + i] +
                               b10_5 * finavalu_temp[4 * EQUATIONS + i] + b10_6 * finavalu_temp[5 * EQUATIONS + i] +
                               b10_7 * finavalu_temp[6 * EQUATIONS + i] + b10_8 * finavalu_temp[7 * EQUATIONS + i] +
    ...
    //===================================================================================================
      ...
      for (i = 0; i < EQUATIONS; i++) {
        initvalu_temp[i] =
            initvalu[i] + h * (b11_1 * finavalu_temp[0 * EQUATIONS + i] + b11_4 * finavalu_temp[3 * EQUATIONS + i] +
                               b11_5 * finavalu_temp[4 * EQUATIONS + i] + b11_6 * finavalu_temp[5 * EQUATIONS + i] +
                               b11_7 * finavalu_temp[6 * EQUATIONS + i] + b11_8 * finavalu_temp[7 * EQUATIONS + i] +
                               b11_9 * finavalu_temp[8 * EQUATIONS + i] + b11_10 * finavalu_temp[9 * EQUATIONS + i]);
      }
    ...
    //===================================================================================================
      ...
      for (i = 0; i < EQUATIONS; i++) {
        initvalu_temp[i] =
            initvalu[i] + h * (b12_1 * finavalu_temp[0 * EQUATIONS + i] + b12_6 * finavalu_temp[5 * EQUATIONS + i] +
                               b12_7 * finavalu_temp[6 * EQUATIONS + i] + b12_8 * finavalu_temp[7 * EQUATIONS + i] +
                               b12_9 * finavalu_temp[8 * EQUATIONS + i] + b12_10 * finavalu_temp[9 * EQUATIONS + i]);
      }
    ...
    //===================================================================================================
      ...
      for (i = 0; i < EQUATIONS; i++) {
        initvalu_temp[i] =
            initvalu[i] + h * (b13_1 * finavalu_temp[0 * EQUATIONS + i] + b13_4 * finavalu_temp[3 * EQUATIONS + i] +
                               b13_5 * finavalu_temp[4 * EQUATIONS + i] + b13_6 * finavalu_temp[5 * EQUATIONS + i] +
                               b13_7 * finavalu_temp[6 * EQUATIONS + i] + b13_8 * finavalu_temp[7 * EQUATIONS + i] +
                               b13_9 * finavalu_temp[8 * EQUATIONS + i] + b13_10 * finavalu_temp[9 * EQUATIONS + i] +
  ...
  for (i = 0; i < EQUATIONS; i++) {
    finavalu[i] = initvalu[i] + h * (c_1_11 * (finavalu_temp[0 * EQUATIONS + i] + finavalu_temp[10 * EQUATIONS + i]) +
  ...
  for (i = 0; i < EQUATIONS; i++) {
    error[i] = fabs(err_factor * (finavalu_temp[0 * EQUATIONS + i] + finavalu_temp[10 * EQUATIONS + i] -
