...
public:
  ...
  size_t read(float *dest, int dim, int num) { return std::fread(dest, sizeof(float) * dim, num, fp); }
...
float pgain(long, Points *, float, long int *, int, bool *, int *, bool *, bool, double *, double *, double *, double *,
            double *, double *);
