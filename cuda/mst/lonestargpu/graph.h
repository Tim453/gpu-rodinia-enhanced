...
typedef struct Graph {
	...
	unsigned read(const char file[]);  // RODINIA: was char[]
	...
	unsigned readFromEdges(const char file[]);  // RODINIA: was char[]
	unsigned readFromGR(const char file[]);  // RODINIA: was char[]
...
unsigned Graph::readFromEdges(const char file[]) {
	std::ifstream cfile;
	cfile.open(file);
...
unsigned Graph::readFromGR(const char file[]) {
	std::ifstream cfile;
	cfile.open(file);
...
unsigned Graph::read(const char file[]) {
