...
static unsigned CudaTest(const char *msg)  // RODINIA: was char *
{
  cudaError_t e;

  cudaDeviceSynchronize();  // RODINIA: was cudaThreadSynchronize()
...
inline int ConvertSMVer2Cores(int major, int minor)
{
	  ...
	  { 0x35, 192}, // Kepler Generation (SM 3.5) GK110 class
          // RODINIA: entries below added; the table originally stopped at SM 3.5
          // and printed "undefined" for every later GPU.
          ...
          { 0x89, 128}, // Ada Generation (SM 8.9) AD10x class
          { 0x90, 128}, // Hopper Generation (SM 9.0) GH100 class
          { 0xa0, 128}, // Blackwell Generation (SM 10.0) GB100 class
          { 0xa1, 128}, // Blackwell Generation (SM 10.1) GB10x class
          { 0xc0, 128}, // Blackwell Generation (SM 12.0) GB20x class
          {   -1, -1 }
        };
