...
void print_comp_mins(ComponentSpace cs, Graph graph, foru *minwtcomponent, unsigned *goaheadnodeofcomponent,
                     unsigned *partners, bool *pin) {
  foru *cminwt;
  unsigned *cgah, *cpart;
  unsigned *ele2comp;
  bool *cpin;
  ...
  assert(cudaMemcpy(cgah, goaheadnodeofcomponent, cs.nelements * sizeof(unsigned), cudaMemcpyDeviceToHost) ==
         cudaSuccess);
...
__global__ void dfindcompmintwo_serial(unsigned *mstwt, Graph graph, ComponentSpace csr, ComponentSpace csw,
                                       foru *eleminwts, foru *minwtcomponent, unsigned *partners, unsigned *phores,
                                       bool *processinnextiteration, unsigned *goaheadnodeofcomponent, unsigned inpid,
