...
static unsigned long str2ushort(unsigned char *str) { return (str[0] | (str[1] << 8)); }
...
#define AVIF_COPYRIGHTED 0x00020000
  ...
  if (lseek(AVI->fdes, 0, SEEK_SET) < 0 || avi_write(AVI->fdes, (char *)AVI_header, HEADERBYTES) != HEADERBYTES ||
...
long AVI_audio_codech_offset(avi_t *AVI) { return AVI->track[AVI->aptr].a_codech_off; }

long AVI_audio_codecf_offset(avi_t *AVI) { return AVI->track[AVI->aptr].a_codecf_off; }
