...
void write_data(char *filename, int frameNo, int frames_processed, int endoPoints, int *input_a, int *input_b,
                int epiPoints, int *input_2a, int *input_2b) {
...
int main(int argc, char *argv[]) {
  ...
  // All kernels operations within kernel use same max size of threads. Size of block size is set to the size
  // appropriate for max size operation (on padded matrix). Other use subsets of that.
  ...
  //	DUMP DATA TO FILE
  //==================================================50
  write_data("result.txt", common.no_frames, frames_processed, common.endoPoints, common.tEndoRowLoc,
             common.tEndoColLoc, common.epiPoints, common.tEpiRowLoc, common.tEpiColLoc);
