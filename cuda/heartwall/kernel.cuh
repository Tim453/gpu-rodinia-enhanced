...
__global__ void kernel() {
  ...
  if (d_common_change.frame_no == 0) {
    ...
    while (ei_new < d_common.in_elem) {
      ...
      // figure out row/col location in corresponding new template area in image and give to every thread (get top left
      // corner and progress down and right)
  ...
  if (d_common_change.frame_no != 0) {
    ...
    while (ei_new < d_common.in2_pad_cumv_sel_elem) {
      ...
      d_unique[bx].d_in2_pad_cumv_sel[ei_new] =
          d_unique[bx].d_in2_pad_cumv[ori_col * d_common.in2_pad_cumv_rows + ori_row];
    ...
    while (ei_new < d_common.in2_sub_cumh_elem) {
      ...
      d_unique[bx].d_in2_sub_cumh[ei_new] =
          d_unique[bx].d_in2_pad_cumv_sel[ei_new] - d_unique[bx].d_in2_sub_cumh[ei_new];
    ...
    while (ei_new < d_common.in2_sub2_elem) {
      ...
      d_unique[bx].d_in2_sqr_sub2[ei_new] =
          d_unique[bx].d_in2_sub_cumh_sel[ei_new] - d_unique[bx].d_in2_sqr_sub2[ei_new];
    ...
    while (ei_new < d_common.conv_elem) {
      ...
      d_unique[bx].d_conv[ei_new] =
          d_unique[bx].d_conv[ei_new] - d_unique[bx].d_in2_sub2[ei_new] * in_final_sum / d_common.in_elem;
