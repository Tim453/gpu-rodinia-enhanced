...
static int getdtablesize() { return __fd_getdtablesize(); }
#else
...
#if (defined(_SUSV3_READLINK) || (!defined(_ALL_SOURCE) && (_POSIX_C_SOURCE >= 200112L)))
/* If SUSV3 readlink specifically requested or if strict SUSv3
 * environment requested */
#ifdef __64BIT__
static ssize_t readlink(const char *__restrict__ __path, char *__restrict__ __buf, size_t __bufsize) {
